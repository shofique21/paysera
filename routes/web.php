...
Route::get('/create-transaction', [App\Http\Controllers\TransactionController::class, 'create_transaction'])->name('createTransaction');
Route::post('/submit-transaction', [App\Http\Controllers\TransactionController::class, 'transaction_submit'])->name('transaction.store');
